...
plt.rcParams.update({
    ...
    "axes.labelsize": 18,              # Dimensione delle etichette sugli assi
    "xtick.labelsize": 15,             # Dimensione delle etichette dell'asse X
    "ytick.labelsize": 15,             # Dimensione delle etichette dell'asse Y
    'legend.fontsize': 15,
    "mathtext.fontset": "cm"
})
plt.rcParams.update({
    "scatter.marker": "o",        # Tipo di marker (cerchio)
    "lines.markersize": 10,       # Grandezza dei marker (valore in punti)
})
